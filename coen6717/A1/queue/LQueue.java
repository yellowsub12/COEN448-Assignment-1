...
// LQueue has methods init(), clear(), enqueue(), dequeue(), frontValue(), length(), toString()
...
public class LQueue<E> implements ADTQueue<E> {
	private coen352.ch4.list.Link<E> front;    // Pointer to front queue node
	private coen352.ch4.list.Link<E> rear;     // Pointer to rear queuenode
